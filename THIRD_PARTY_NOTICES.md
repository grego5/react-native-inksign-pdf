...
recorded in `third_party/pdfium/manifest.json`.
...
`27.1.12297006`. The workflow publishes static Android and iOS binaries as
checksummed GitHub Release assets for Gradle and the macOS npm postinstall
