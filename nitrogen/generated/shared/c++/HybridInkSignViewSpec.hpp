...
namespace margelo::nitro::inksignpdf {
  ...
  /**
   * An abstract base class for `InkSignView`
   * Inherit this class to create instances of `HybridInkSignViewSpec` in C++.
   * You must explicitly call `HybridObject`'s constructor yourself, because it is virtual.
   * @example
   * ```cpp
   * class HybridInkSignView: public HybridInkSignViewSpec {
   * public:
   *   HybridInkSignView(...): HybridObject(TAG) { ... }
   *   // ...
   * };
   * ```
   */
  class HybridInkSignViewSpec: public virtual HybridObject {
    public:
      // Constructor
      explicit HybridInkSignViewSpec(): HybridObject(TAG) { }

      // Destructor
      ~HybridInkSignViewSpec() override = default;
    ...
    public:
      ...
      virtual std::shared_ptr<Promise<AddPagesResult>> scanPages() = 0;
    ...
    protected:
      // Tag for logging
      static constexpr auto TAG = "InkSignView";
  };
