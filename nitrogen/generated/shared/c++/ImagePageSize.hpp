...
namespace margelo::nitro::inksignpdf {
  ...
  /**
   * A struct which can be represented as a JavaScript object (ImagePageSize).
   */
  struct ImagePageSize final {
  public:
    double width     SWIFT_PRIVATE;
    double height     SWIFT_PRIVATE;

  public:
    ImagePageSize() = default;
    explicit ImagePageSize(double width, double height): width(width), height(height) {}

  public:
    friend bool operator==(const ImagePageSize& lhs, const ImagePageSize& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ ImagePageSize <> JS ImagePageSize (object)
  template <>
  struct JSIConverter<margelo::nitro::inksignpdf::ImagePageSize> final {
    static inline margelo::nitro::inksignpdf::ImagePageSize fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::inksignpdf::ImagePageSize(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::inksignpdf::ImagePageSize& arg) {
