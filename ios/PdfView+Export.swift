...
extension PdfView {
  ...
  static func writePDF(source: URL,
    ...
    for captured in pages {
      guard let verifiedPage = verifiedDocument.page(at: captured.pageIndex),
            normalizedRotation(verifiedPage.rotation) == normalizedRotation(captured.geometry.rotation),
