...
Assert-Contains $pageView 'let rendered = try session\.renderPage\(' 'live tiles render through PDFium'
Assert-Contains $preview 'let rendered = try request\.pdfiumSession\.renderPage\(' 'previews render through PDFium'
