...
$typescriptContractPath = Join-Path $repositoryRoot "src\PdfView.nitro.ts"
...
Assert-SourceContains $typescriptContractPath 'increaseTextSize\(\): Promise<number>' 'Nitro increaseTextSize contract'
Assert-SourceContains $typescriptContractPath 'decreaseTextSize\(\): Promise<number>' 'Nitro decreaseTextSize contract'
Assert-SourceContains $typescriptContractPath 'removeTextAnnotation\(\): Promise<void>' 'Nitro removeTextAnnotation contract'
Assert-SourceContains $typescriptContractPath 'insertAnnotationOn\(\): Promise<void>' 'Nitro insertAnnotationOn contract'
Assert-SourceContains $typescriptContractPath 'insertAnnotationOff\(\): Promise<void>' 'Nitro insertAnnotationOff contract'
